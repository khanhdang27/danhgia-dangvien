    ...
    <div id="cbtxl-module">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="title">Chi bộ tự xếp loại</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Trang chủ</a></li>
                        <li class="breadcrumb-item active">Chi bộ tự xếp loại</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="mb-3 d-flex justify-content-end group-btn">
            <a href="{{ route("get.cbtxl.create") }}" class="btn btn-primary"
...
{{--                                    <td>{{ Rating::getXeploai($item->dut)}}</td>--}}
                                    <td class="link-action">
                                        ...
                                        @else
                                            <a href="{{ route('get.cbtxl.update',['macb'=>$item->macb,'nam'=>$item->nam])}}"
                                               class="btn btn-primary"
                                               data-toggle="modal" data-target="#form-modal"
                                               data-title="Chỉnh sửa tự xếp loại">
                                                <i class="fa fa-pencil"></i></a>
                                            <a href="{{ route('get.cbtxl.delete',['macb'=>$item->macb,'nam'=>$item->nam]) }}"
