        ...
        <div class="card">
            ...
            <div class="card-body px-5">
                <div class="table-responsive mb-1">
                    ...
                    <p class="m-0 font-18 font-weight-bold text-center">Tặng giấy khen cho chi bộ trực thuộc Đảng ủy cơ
                        sở</p>
                    <br>
                    ...
                    <p style="text-indent: 25px">- Căn cứ Hướng dẫn số 03-HD/ĐU ngày 03/12/2021 của Đảng ủy Trường Đại
                        học Cần Thơ về <strong>"kiểm điểm, đánh giá, xếp loại chất lượng tổ chức cơ sở đảng và đảng viên
                            năm
                            2021”</strong> và kết quả xếp loại chất lượng các chi bộ trực thuộc năm 2021,</p><br>
                    ...
                    <table class="mb-4">
                        <tr>
                            ...
                            <td><p class="m-0 font-16">Tặng Giấy khen cho {{count($data)}} chi bộ xếp loại chất lượng
                                    "<strong>Hoàn thành xuất sắc nhiệm vụ</strong>" năm {{$nam}}:</p>
                            </td>
                        </tr>
                        @foreach($data as $key => $cb)
                            <tr>
                                <td></td>
                                <td><p class="m-0 font-16"></p>{{++$key}})
                                    {{$cb->chibo != null ? $cb->chibo->tencb : ''}}{{$key != count($data) ? ',' : ''}}
                                </td>
                            </tr>
                        @endforeach
                        <tr>
                            <td class="align-top pt-4" nowrap><p class="m-0 font-16 font-weight-bold">Điều 2.</p></td>
                            <td class="pt-4"><p class="m-0 font-16">Mức tiền thưởng kèm theo giấy khen là 900.000 đồng/giấy khen,
                                    trích từ quỹ đảng phí của Đảng bộ.</p>
                            </td>
                        </tr>
                        <tr>
                            <td class="align-top" nowrap><p class="m-0 font-16 font-weight-bold">Điều 3.</p></td>
                            <td><p class="m-0 font-16">Các chi bộ trực thuộc có tên ở Điều 1 chịu trách nhiệm thi hành
                                    Quyết định này.</p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" class="mb-5">
                        <tr>
                            <td nowrap class="align-top">
                                ...
                                <p class="m-0 font-14">- Đảng uỷ trường (để báo cáo),</p>
