...
namespace Modules\Member\Requests;
...
class MemberRequest extends FormRequest{
    ...
    public function rules(){
        $method = segmentUrl(2);
        if(segmentUrl(0) === 'member-profile'){
            if(segmentUrl(1) === 'change-avatar'){
                return [
        ...
        switch($method){
            ...
            case 'create':
                return [
                    ...
                    'phone'             => 'required|digits:8|nullable|validate_unique:members',
                    'password_re_enter' => 're_enter_password|required_with:password',
                ];
            case 'update':
                return [
                    ...
                    'avatar'            => 'image|mimes:jpeg,png,jpg,gif,svg|max:4096',
                    'phone'             => 'required|digits:8|nullable|validate_unique:members,' . $this->id,
                    'password'          => 'min:6|nullable',
                    'password_re_enter' => 're_enter_password|required_with:password',
                ];
        }
